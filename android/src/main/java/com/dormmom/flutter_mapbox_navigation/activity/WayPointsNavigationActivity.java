...
public class WayPointsNavigationActivity extends AppCompatActivity implements OnNavigationReadyCallback,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        points = (List<Point>)getIntent().getSerializableExtra("waypoints");
    ...
    private void fetchRoute(Point origin, Point destination) {
        NavigationRoute.builder(this)
                ...
                .alternatives(true)
                .profile(FlutterMapboxNavigation.Companion.getNavigationMode())
                .language(FlutterMapboxNavigation.Companion.getNavigationLanguage())
                .voiceUnits(FlutterMapboxNavigation.Companion.getNavigationVoiceUnits())
                .build()
                    ...
                    public void onResponse(@NotNull Call<DirectionsResponse> call, @NotNull Response<DirectionsResponse> response) {
                        ...
                        if (directionsResponse != null) {
                            if(!directionsResponse.routes().isEmpty())
                                ...
                                PluginUtilities.Companion.sendEvent(MapBoxEvents.ROUTE_BUILD_FAILED, message);
                                finish();
                            }
                        }
